...
class BME680BSECComponent : public Component, public i2c::I2CDevice {
 public:
  ...
  static int8_t read_bytes_wrapper(uint8_t a_register, uint8_t *data, uint len, void *inst_v);
  static int8_t write_bytes_wrapper(uint8_t a_register, const uint8_t *data, uint len, void *inst_v);
 ...
 protected:
  ...
  bme68x_conf bme68x_conf_;
  bme68x_heatr_conf bme68x_heatr_conf_;
